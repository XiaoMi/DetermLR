# Proofwriter with Chain-of-Thought
import re
import guidance
import json
import time
...
def main():
    ...
    logfilename = 'results/proofwriter/results-folio-cot-openai--' + model_name + '--' + dataset_name + '--k_' + str(args.majoritycnt) + '--' + time.strftime("%Y-%m-%d-%H-%M-%S", t) + '.jsonl'
