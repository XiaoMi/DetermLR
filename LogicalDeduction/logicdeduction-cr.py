# LOGICALDEDUCTION with Cumulative Reasoning
import requests
import guidance
import ast
import argparse
...
def main():
    ...
    for example in tqdm(data, desc="Evaluating", unit="example"):
        ...
        if args.condition_divide:
            # premise identification no use in CR
        ...
        while (len(propositions) < args.propnum and failed_cnt < args.trycnt):  
            ...
            # useful deduction when setting is true.
